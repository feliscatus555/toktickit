...
export default function TicketDetail({ ticketId, currentRequester, onBack, backLabel }) {
    ...
    if (error || !ticket) {
        return (_jsx("div", { style: { maxWidth: 960, margin: "2rem auto", padding: "0 1rem" }, children: _jsxs("div", { id: "ticket-detail-error-banner", className: "alert alert-danger shadow-sm", role: "alert", style: { backgroundColor: "#FCE8E6", borderColor: "#B3261E", color: "#B3261E" }, children: [_jsx("h5", { className: "alert-heading fw-bold mb-1", children: "Error Loading Ticket" }), _jsx("p", { className: "mb-3", children: error || "Ticket not found or ownership denied." }), _jsx("button", { id: "ticket-error-back-btn", type: "button", className: "btn btn-outline-danger btn-sm fw-semibold", onClick: onBack, children: displayBackLabel })] }) }));
    }
    ...
    return (_jsxs("div", { style: { maxWidth: 1040, margin: "0 auto", paddingBottom: "3rem" }, children: [_jsxs("div", { className: "d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2", children: [_jsx("button", { type: "button", onClick: onBack, style: {
                            ...
                            gap: "0.5rem",
                                                    ...
                                                    alignItems: "center",
                                                    gap: "0.25rem",
                                                }, children: [_jsx("span", { children: "\u26A0" }), _jsx("span", { children: statusError })] })), _jsxs("div", { className: "d-flex gap-2 justify-content-end", children: [_jsx("button", { type: "button", className: "btn btn-sm btn-outline-secondary", onClick: () => {
                                                            setSelectedNextStatus("");
                                                            setResolutionSummaryInput("");
                                                            setStatusError(null);
                                                        }, disabled: updatingStatus, children: "Cancel" }), _jsx("button", { type: "button", id: "confirm-resolve-btn", className: "btn btn-sm text-white fw-bold", style: { backgroundColor: "#006B3C" }, disabled: updatingStatus, onClick: handleConfirmResolve, children: updatingStatus ? "Resolving..." : "Confirm Resolve" })] })] }))] }), _jsx("hr", { style: { borderColor: "#E5E7EB" } }), _jsxs("div", { className: "mb-4", children: [_jsx("label", { style: { fontSize: "0.8rem", fontWeight: 700, color: "#5B6573", display: "block", marginBottom: "0.3rem" }, children: "Summary" }), _jsx("div", { style: {
