...
describe("StaffTicketQueue Component (UI-03, UI-04, AC-07, AC-08, FR-15, FR-11)", () => {
    ...
    describe("UI-04: Queue search, filter, and pagination reactivity (AC-08, FR-11)", () => {
        it("updates query when user enters search term", async () => {
            ...
            await waitFor(() => {
                expect(api.fetchStaffTickets).toHaveBeenCalledWith(expect.objectContaining({ search: "VPN", page: 1 }));
            });
        });
        it("updates query when user selects category filter", async () => {
            ...
            await waitFor(() => {
                expect(api.fetchStaffTickets).toHaveBeenCalledWith(expect.objectContaining({ category: "4", page: 1 }));
            });
        });
        it("updates query when user selects status filter", async () => {
            ...
            await waitFor(() => {
                expect(api.fetchStaffTickets).toHaveBeenCalledWith(expect.objectContaining({ status: "InProgress", page: 1 }));
            });
        });
        it("updates query when user selects priority filter", async () => {
            ...
            await waitFor(() => {
                expect(api.fetchStaffTickets).toHaveBeenCalledWith(expect.objectContaining({ priority: "URGENT", page: 1 }));
            });
        });
        it("updates query when user selects owner filter", async () => {
            ...
            await waitFor(() => {
                expect(api.fetchStaffTickets).toHaveBeenCalledWith(expect.objectContaining({ owner: "unassigned", page: 1 }));
            });
        });
        it("shows Clear Filters button and resets all filters when clicked", async () => {
            ...
            await waitFor(() => {
                ...
                expect(api.fetchStaffTickets).toHaveBeenCalledWith(expect.objectContaining({ search: undefined, page: 1 }));
            });
        });
