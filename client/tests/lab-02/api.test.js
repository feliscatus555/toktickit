...
import { fetchTicketDetail, uploadAttachment, getAttachmentDownloadUrl, downloadAttachmentBlob, softRemoveAttachment, } from "../../src/api";
describe("Client API Service Layer — Feature 8", () => {
    ...
    describe("fetchTicketDetail", () => {
        it("fetches ticket details with header", async () => {
            ...
            expect(globalThis.fetch).toHaveBeenCalledWith(expect.stringContaining("/api/tickets/tkt-123"), expect.objectContaining({
                headers: {
    ...
    describe("uploadAttachment", () => {
        it("uploads FormData file payload on success", async () => {
            ...
            expect(globalThis.fetch).toHaveBeenCalledWith(expect.stringContaining("/api/tickets/tkt-123/attachments"), expect.objectContaining({
                method: "POST",
                headers: {
                    "X-Development-Requester-Id": "1",
                },
    ...
    describe("softRemoveAttachment", () => {
        it("sends DELETE request with removerId and reason in JSON body on success", async () => {
            ...
            expect(globalThis.fetch).toHaveBeenCalledWith(expect.stringContaining("/api/attachments/att-1"), expect.objectContaining({
                method: "DELETE",
                headers: {
